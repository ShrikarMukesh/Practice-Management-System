...
public class ResetUserPassword implements Serializable {
	/**
	 * 
	 */
	...
	@JsonProperty(value = "passwordResetType", required = true)
	@NotNull(message = "Password Reset Type cannot be null/empty")
	@Pattern(regexp = "^(CHANGE|RESET)", message = "Invalid data, supported are CHANGE or RESET")
	private String pwdResetType;
	...
	public String getPwdResetType() {
		return pwdResetType;
	}

	public void setPwdResetType(String pwdResetType) {
		this.pwdResetType = pwdResetType;
	}
