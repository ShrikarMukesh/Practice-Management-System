...
public class EmailService {
	...
	public void sendMessageUsingFreemarkerTemplateForResetpassword(String to, String subject,
			Map<String, Object> templateModel) throws IOException, TemplateException, MessagingException {
		Template freemarkerTemplate = freemarkerConfigurer.getConfiguration().getTemplate("resetPassword.html");
